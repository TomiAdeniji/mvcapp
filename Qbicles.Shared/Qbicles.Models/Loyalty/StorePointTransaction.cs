...
{
    [Table("loy_StorePointTransaction")]
    public class StorePointTransaction
    {
    ...
    public enum StorePointTransactionType
    {
        Credit = 1,
        Debit = 2
    }
    ...
    public enum StorePointTransactionReason
    {
        GeneratedFromPayment = 1,
        // Leave out the following for now
        //GeneratedFomOrder = 2,
        ConvertedToStoreCredit = 3
        // Leave out the following for now
