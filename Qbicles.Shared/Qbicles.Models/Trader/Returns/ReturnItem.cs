...
namespace Qbicles.Models.Trader.Returns
{
    ...
    public class ReturnItem
    {
        ...
        /// <summary>
        /// The UTC date and time on which the Return Itemwas created
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// The Application user who created the return item
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// This is a collection of any log items associated with the Return Item
        /// </summary>
        public virtual List<ReturnItemLog> Logs { get; set; } = new List<ReturnItemLog>();
